      ...
      <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-xl shadow-lg">
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-600">
            Join the platform to start booking event tickets.
          </p>
        </div>
        ...
        <div className="mt-8 space-y-6">
          {success ? (
             <div className="bg-green-50 text-green-700 p-4 rounded-md text-center">
               ...
               <p className="text-sm mt-1">Logging you in...</p>
             </div>
          ) : (
          ...
          <p className="mt-2 text-center text-xs text-gray-500">
            Already have an account? <a href="/login" className="text-indigo-600 hover:text-indigo-500 font-medium">Log in here</a>.
          </p>
